...
static __m128i __verusclmulwithoutreduction64alignedrepeatv2_1(__m128i *randomsource, const __m128i buf[4], uint64_t keyMask,
	uint32_t *fixrand, uint32_t *fixrandex, _m128i *g_prand, _m128i *g_prandex)
{
	const __m128i *pbuf;
